...
UKBBdata<- read.csv("C:/Users/1/Desktop/文章最新版/代码/R/ukbb_chu.csv")
...
write.csv(unstd_loadings, file = "C:/Users/1/Desktop/文章最新版/代码/R/unstandardized_loadings.csv", row.names = FALSE)

# 提取标准化的因子载荷及其置信区间
std_loadings <- parameterEstimates(fit, standardized = TRUE, ci = TRUE)
std_loadings <- std_loadings[std_loadings$op == "=~", ]
print(std_loadings)
write.csv(std_loadings, file = "C:/Users/1/Desktop/文章最新版/代码/R/standardized_loadings_with_CI.csv", row.names = FALSE)